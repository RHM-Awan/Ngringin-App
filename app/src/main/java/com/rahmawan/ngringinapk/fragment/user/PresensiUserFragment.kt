...
class PresensiUserFragment : Fragment() {
    private lateinit var bind: FragmentPresensiUserBinding
    ...
    override fun onCreateView(
        ...
        bind = FragmentPresensiUserBinding.inflate(inflater,container,false)
        initListener()
    ...
    private fun initListener(){
        getAgenda.setOnAgendasListener(object : GetAgendas.GetAgendasListener{
            override fun onSuccess(result: ArrayList<Agenda>) {
                ...
                bind.rvPresensi.adapter = PresensiAdapter(result, "user")
                return a
            }
